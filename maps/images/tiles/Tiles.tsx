...
<tileset version="1.5" tiledversion="1.6.0" name="Tiles" tilewidth="128" tileheight="128" tilecount="13" columns="0">
 <grid orientation="orthogonal" width="1" height="1"/>
 <tile id="156">
  <image width="128" height="128" source="ConcreteLeft.png"/>
 </tile>
 <tile id="157">
  <image width="128" height="128" source="ConcreteMid.png"/>
 </tile>
 <tile id="158">
  <image width="128" height="128" source="ConcreteRight.png"/>
 </tile>
 <tile id="160">
  <image width="128" height="128" source="ConcreteSide.png"/>
 </tile>
 <tile id="161">
 ...
 <tile id="164">
  ...
  <objectgroup draworder="index" id="2">
   <object id="6" x="29.25" y="48.5" width="72.5" height="78.25"/>
  </objectgroup>
 </tile>
 <tile id="166">
  <properties>
 ...
 <tile id="170">
  <image width="128" height="128" source="Ladder.png"/>
 </tile>
</tileset>
